...
function SearchButton({ contentList }) {
    ...
    return (
        <>
            <button className="searchBtn" onClick={openModal}>
                <svg classname="searchIcon" width="4vh" height="3vw" viewBox="0 0 20 20" fill="none">
                    <path
            ...
            <Search isOpen={isModalOpen} close={closeModal} contentList={contentList} />
        </>
    );
}
